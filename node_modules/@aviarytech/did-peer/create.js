...
export const createNumAlgo0 = async (authenticationKey) => {
    validateAuthentication(authenticationKey);
    return `did:peer:0${authenticationKey.publicKeyMultibase}`;
};
export const createNumAlgo1 = async () => {
    throw new Error('NumAlgo1 not supported');
};
export const createNumAlgo2 = async (authenticationKeys, encryptionKeys, service) => {
