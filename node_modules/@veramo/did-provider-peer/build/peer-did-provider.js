...
export class PeerDIDProvider extends AbstractIdentifierProvider {
    ...
    async createIdentifier({ kms, options }, context) {
        if (options.num_algo == 0) {
            ...
            const methodSpecificId = base58btc.encode(Multicodec.addPrefix('ed25519-pub', hexToBytes(key.publicKeyHex)));
            const identifier = {
            ...
            const authKeyText = base58btc.encode(Multicodec.addPrefix('ed25519-pub', hexToBytes(authKey.publicKeyHex)));
            const agreementKeyText = base58btc.encode(Multicodec.addPrefix('x25519-pub', hexToBytes(agreementKey.publicKeyHex)));
