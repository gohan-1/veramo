 ...
 * @public
 */
export const WebDidDocRouter = (options) => {
    const router = Router();
    const didDocForIdentifier = (identifier) => {
    ...
    const getAliasForRequest = (req) => {
        return encodeURIComponent(req.get('host') || req.hostname);
    };
    router.get(didDocEndpoint, async (req, res) => {
        if (req.agent) {
            try {
...
//# sourceMappingURL=web-did-doc-router.js.map